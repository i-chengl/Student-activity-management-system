...
class Activity extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['act_name', 'act_date_beg', 'act_date_end', 'act_is_personal', 'act_id_submit', 'act_partici', 'act_id_cat', 'act_detail'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'act_id_submit' => '活动组织者/提交者',
            'act_host' => '主办方',
            'act_partici' => '活动参与者(空格分隔)',
            'act_id_cat' => '活动所属类别id',
